# the a-star() function is from 'A Star in Python' Posted: 2019-12-01 14:43, Last Updated: 2019-12-14 12:39
#   at https://www.algorithms-and-technologies.com/a_star/python
#   includes code, clear explanation and simple example
#   note that the user needs to provide the parameters 

# other sources for visualization, etc...
